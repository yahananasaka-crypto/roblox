...
local function applyConfig(config)
    ...
    if config.smoothToggle ~= nil then
        ...
        if G.smoothButton then
            G.smoothButton.Text = smoothToggle and "Smooth: ON" or "Smooth: OFF"
            G.smoothButton.BackgroundColor3 = smoothToggle and Color3.fromRGB(0,180,0) or Color3.fromRGB(40,40,40)
        end
    end
    ...
    if config.charmsNpc ~= nil then
        ...
        if G.charmsNpcButton then
            G.charmsNpcButton.Text = charmsNpcEnabled and "NPC: ON" or "NPC: OFF"
            G.charmsNpcButton.BackgroundColor3 = charmsNpcEnabled and Color3.fromRGB(0,180,0) or Color3.fromRGB(40,40,40)
        end
    end

    if config.charmsEspObj ~= nil then
        charmsEspObjEnabled = config.charmsEspObj
        if G.charmsEspObjButton then
            G.charmsEspObjButton.Text = charmsEspObjEnabled and "ESP Objects: ON" or "ESP Objects: OFF"
            G.charmsEspObjButton.BackgroundColor3 = charmsEspObjEnabled and Color3.fromRGB(0,180,0) or Color3.fromRGB(40,40,40)
        end
    end
...
makeDraggable(G.mobileSpaceFrame)
